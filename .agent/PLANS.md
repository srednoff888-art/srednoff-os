# PLANS.md — ExecPlan для больших задач Codex

ExecPlan — это living document, который позволяет Codex вести большую задачу от исследования до production-ready результата.
