...
description: Use this skill when reviewing external system-prompt repositories, leaked-prompt archives, agent prompt dumps, Fable/Claude/OpenAI/Codex prompt examples, or prompt-engineering collections to safely improve Srednoff OS without copying proprietary text.
---
