...
Copy-TemplateItem ".codex\skill-index.json"
...
Copy-DirectoryContents -Source (Join-Path $PackageRoot "docs") -Destination (Join-Path $CodexHome "docs") -Label "docs"
